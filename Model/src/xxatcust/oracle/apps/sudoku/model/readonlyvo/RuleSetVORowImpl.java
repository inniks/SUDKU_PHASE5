...
public class RuleSetVORowImpl extends ViewRowImpl {
    ...
    public static final int TOPLEVELMEANING = AttributesEnum.TopLevelMeaning.index();
    public static final int SECONDLEVELCODE = AttributesEnum.SecondLevelCode.index();
    public static final int SECONDLEVELMEANING = AttributesEnum.SecondLevelMeaning.index();
    public static final int LOVSWITCHER = AttributesEnum.LOVSwitcher.index();
    public static final int RULESETTOPLEVELLOV1 = AttributesEnum.RuleSetTopLevelLOV1.index();
    public static final int RSETSECLEVELLOVI1 = AttributesEnum.RSetSecLevelLOVI1.index();
    public static final int RSETSECLEVELLOVII1 = AttributesEnum.RSetSecLevelLOVII1.index();
            ...
            if (secondLevelCode != null) {
                ...
                if (topLevelCode != null &&
                    ...
                    if (rows != null && rows.length > 0) {
                        ...
                        System.out.println("VO Row Impl E8000SYS : SecondLevel "+secondLevelMeaning);
                    }
                }
                if (topLevelCode != null &&
                    ...
                    if (rows != null && rows.length > 0) {
                        secondLevelMeaning =
                                (String)rows[0].getAttribute("Meaning");
                        System.out.println("VO Row Impl E8008SYS : SecondLevel "+secondLevelMeaning);
                    }
                }
            }
        }
    ...
    public String retrieveSecLevelMeaning(String secondLevelCode){
        String secondLevelMeaning = null ;
        if (secondLevelCode != null) {
            Object[] obj = { secondLevelCode };
            Key key = new Key(obj);
            ...
            if (topLevelCode != null &&
                topLevelCode.equalsIgnoreCase("E8008SYS")) {
                //use 2nd lov
                Row[] rs = this.getRSetSecLevelLOVII1().getAllRowsInRange() ;
                Row[] rows = this.getRSetSecLevelLOVI1().findByKey(key, 1);
                //RowSet rset = this.getRSetSecLevelLOVI1() ;
