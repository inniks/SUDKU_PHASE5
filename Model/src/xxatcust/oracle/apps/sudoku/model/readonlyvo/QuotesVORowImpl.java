...
//                                   rows.length);
    ...
    public String getPaymentTerms() {
        String paymentTermsMean = null;
        if ((String)getAttributeInternal(PAYMENTTERMSMEAN) != null) {

            Object[] obj = { getAttributeInternal(PAYMENTTERMSMEAN) };
            Key key = new Key(obj);
//            System.out.println("Key Created " + key);
            Row[] rows = this.getPaymentTermsVO().findByKey(key, 1);
//            System.out.println("Estimated currency rows " + rows.length);
            if (rows != null && rows.length > 0) {
                paymentTermsMean = (String)rows[0].getAttribute("Description");
            }

            return paymentTermsMean;
        } else
    ...
    public String getIncoTerms() {
        String incoTermsMeaning = null;
        if (getAttributeInternal(INCOTERMSMEANING) != null) {
            Object[] obj = { getAttributeInternal(INCOTERMSMEANING) };
            Key key = new Key(obj);
//            System.out.println("Key Created " + key);
            Row[] rows = this.getIncoTermVO1().findByKey(key, 1);
//            System.out.println("Estimated currency rows " + rows.length);
            if (rows != null && rows.length > 0) {
                incoTermsMeaning = (String)rows[0].getAttribute("Description");
//                System.out.println("Currency Meaning " + incoTermsMeaning);
            }

            return incoTermsMeaning;
        }
